...
const api_client_1 = __importDefault(require("./evaluate/api-client"));
exports.GalileoEvaluateApiClient = api_client_1.default;
const workflow_1 = __importDefault(require("./evaluate/workflow"));
exports.GalileoEvaluateWorkflow = workflow_1.default;
const api_client_2 = __importDefault(require("./observe/api-client"));
exports.GalileoObserveApiClient = api_client_2.default;
const callback_1 = __importDefault(require("./observe/callback"));
exports.GalileoObserveCallback = callback_1.default;
const workflow_2 = __importDefault(require("./observe/workflow"));
