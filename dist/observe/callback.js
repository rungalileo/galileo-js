...
const api_client_js_1 = __importDefault(require("./api-client.js"));
const step_types_js_1 = require("../types/step.types.js");
class GalileoObserveCallback extends base_1.BaseCallbackHandler {
    constructor(project_name, version) {
        ...
        this.api_client = new api_client_js_1.default();
    }
    async init() {
    ...
    handleLLMStart(llm, prompts, runId, parentRunId, extraParams, tags, metadata) {
        ...
        this.records[node_id] = {
            ...
            node_type: step_types_js_1.StepType.llm,
    ...
    handleChatModelStart(llm, messages, runId, parentRunId, extraParams, tags, metadata) {
        ...
        this.records[node_id] = {
            ...
            tags: tags,
            user_metadata: metadata,
            node_type: step_types_js_1.StepType.chat,
            version: this.version,
            has_children: false
        };
    }
    ...
    handleChainStart(chain, inputs, runId, parentRunId, tags, metadata) {
        ...
        if (typeof inputs === 'string') {
            ...
            node_input = Object.fromEntries(Object.entries(inputs).filter(([key, value]) => key && value && typeof value === 'string'));
        }
        ...
        this.records[node_id] = {
            ...
            tags: tags,
            user_metadata: metadata,
            node_type: step_types_js_1.StepType.chain,
            version: this.version,
            has_children: false
        };
    }
    ...
    handleToolStart(tool, input, runId, parentRunId, tags, metadata) {
        ...
        this.records[node_id] = {
            ...
            tags: tags,
            user_metadata: metadata,
            node_type: step_types_js_1.StepType.tool,
            version: this.version,
            has_children: false
        };
    }
    ...
    async handleAgentEnd(action, runId) {
        ...
        const record = this.records[node_id];
        record.latency_ms = latency_ms;
        record.node_type = step_types_js_1.StepType.agent;
        record.status_code = 200;
        await this._finalize_node(record);
    }
    handleRetrieverStart(retriever, query, runId, parentRunId, tags, metadata) {
        ...
        this.records[node_id] = {
            ...
            tags: tags,
            user_metadata: metadata,
            node_type: step_types_js_1.StepType.retriever,
            version: this.version,
            has_children: false
        };
    }
...
exports.default = GalileoObserveCallback;
