...
| 3b  | Both `projectId` and `projectName` given                             | `"Provide only one of projectId or name"`                                                                                                                                         | Project resolution     |
| 3c  | No argument, and both `GALILEO_PROJECT_ID` and `GALILEO_PROJECT` set | `"Provide only one of the environment variables GALILEO_PROJECT_ID or GALILEO_PROJECT"`                                                                                           | Project resolution     |
