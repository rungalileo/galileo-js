...
export type BaseScorerVersionDb = {
  ...
  luna3_scorer?: BaseLuna3ScorerDb | null;
  /**
   * Model Name
   */
  model_name?: string | null;
...
export type BaseScorerVersionResponse = {
  ...
  luna3_scorer?: Luna3ScorerResponse | null;
  /**
   * Model Name
   */
  model_name?: string | null;
...
export type ExtendedTraceRecord = {
   ...
   */
  dataset_generated_output?: string | null;
  /**
   * Is Complete
   *
...
export type ScorerResponse = {
   ...
   * Projects Used
   */
  projects_used?: Array<ScorerScopeProjectRef>;
};
