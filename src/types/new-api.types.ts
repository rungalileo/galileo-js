...
export type BaseScorerVersionDb = {
  ...
  luna3Scorer?: BaseLuna3ScorerDb | null;
  /**
   * Model Name
   */
  modelName?: string | null;
...
export type BaseScorerVersionResponse = {
  ...
  luna3Scorer?: Luna3ScorerResponse | null;
  /**
   * Model Name
   */
  modelName?: string | null;
...
/**
 * CreateLuna3ScorerVersionRequest
 *
 * Immutable LUNA 3 execution fields for a new scorer version.
 */
export type CreateLuna3ScorerVersionRequest = {
  /**
   * Instruction
   */
  instruction: string;
...
export type ExtendedTraceRecord = {
   ...
   *
   * Generated output from the dataset associated with this trace
   */
  datasetGeneratedOutput?: string | null;
  /**
   * Is Complete
   *
...
export type ListScorersRequest = {
  ...
  filters?: Array<
    ...
    | ({
        name: 'exclude_non_o11y_slm_scorers';
      } & ScorerExcludeNonO11ySlmScorersFilter)
    | ({
 ...
 * Luna3ScorerResponse
 */
export type Luna3ScorerResponse = {
  /**
   * Instruction
   */
  instruction: string;
...
export type Model = {
   ...
   * Name
   *
   * Provider model identifier used to match the model to its configured provider deployment or profile.
   */
  name: string;
  /**
   * Alias
   *
   * Galileo model identifier used in settings and API requests to select this model.
   */
  alias: string;
  /**
   * Display Name
   *
   * Human-readable model name shown in the UI. Defaults to the alias for legacy registrations.
   */
  displayName?: string;
...
export const OrganizationAction = {
  ...
  READ_AI_USAGE_ORGANIZATION: 'read_ai_usage_organization',
  READ_UNREDACTED_DATA: 'read_unredacted_data'
} as const;
...
export const ProjectAction = {
  ...
  CONFIGURE_RATE_LIMIT: 'configure_rate_limit',
...
export type RecommendedModelsResponse = {
   ...
   * Model Display Names
   *
   * UI labels keyed by the model aliases returned in supported and available.
   */
  modelDisplayNames?: {
    [key: string]: string;
  };
...
export type RuntimeScorerConfig = {
  ...
  modelType?: ModelType | null;
  /**
   * Trusted intrinsic input requirements for synchronous direct invocation.
   */
  invocation?: ScorerInvocationConfig | null;
  chainpollTemplate?: ChainPollTemplate | null;
  /**
 ...
 * ScorerExcludeNonO11ySlmScorersFilter
 *
 * Internal filter: like ScorerExcludeSlmScorersFilter, but keeps the Luna metrics cleared
 * for the O11y launch. Auto-appended by the service layer when the `o11y_luna_metrics`
 * carve-out is on, in place of the exclude-all filter.
 */
export type ScorerExcludeNonO11ySlmScorersFilter = {
  /**
   * Name
   */
  name?: 'exclude_non_o11y_slm_scorers';
 ...
 * ScorerName
 */
export type ScorerName = (typeof ScorerName)[keyof typeof ScorerName];
...
export type ScorerResponse = {
   ...
   * Projects Used
   */
  projectsUsed?: Array<ScorerScopeProjectRef>;
};
...
export type TestScore = {
   ...
   * Score
   */
  score?: string | number | number | boolean | null;
};
...
export const UserAction = {
  ...
  CHANGE_ROLE_TO_CAPABILITY_BASED: 'change_role_to_capability_based'
} as const;
...
export type GetProjectsPaginatedProjectsPaginatedPostData = {
  ...
  query?: {
     ...
     * Actions
     *
     * Actions to include in the 'permissions' field. Deprecated 'update' values are ignored.
     */
    actions?: Array<ProjectAction | 'update'>;
    /**
     * Starting Token
     */
    startingToken?: number;
...
export type CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostData = {
  body: CreateLuna3ScorerVersionRequest;
  path: {
    /**
     * Scorer Id
     */
  ...
  query?: never;
  url: '/scorers/{scorer_id}/version/luna3';
};

export type CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostErrors = {
  /**
   * Validation Error
   */
  422: HttpValidationError;
...
export type CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostError =
  CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostErrors[keyof CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostErrors];

export type CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostResponses = {
  /**
   * Successful Response
   */
  200: BaseScorerVersionResponse;
...
export type CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostResponse =
  CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostResponses[keyof CreateLuna3ScorerVersionScorersScorerIdVersionLuna3PostResponses];
...
export type GetSessionProjectsProjectIdSessionsSessionIdGetData = {
  ...
  query?: {
     ...
     * Include Redacted Io
     *
     * If False, omit the `redacted_input` and `redacted_output` fields from the response. When redaction is active these hold the same text already returned in `input`/`output`, so clients that do not read them can halve the payload. This does not change whether redaction is applied.
     */
    includeRedactedIo?: boolean;
  };
